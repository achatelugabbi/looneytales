...
swarna_kamalam_video = Video.new(link: 'http://www.youtube.com/watch?v=BsGhE116zLQ', title: 'Swarna Kamalam', language: 2, host: 'youtube', duration: 8571, is_movie: true, genre: 3)
